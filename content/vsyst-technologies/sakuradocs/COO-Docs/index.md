...
Every lesson ends with exercises that produce something real: a signed operating agreement, a filled scorecard, a compliance calendar, an SOP, a decision log entry. The [[toolkit/index|COO Toolkit]] holds the 30 templates those exercises fill, and [vsyst-coo-workbook.xlsx](toolkit/vsyst-coo-workbook.xlsx) holds the spreadsheets (runway & 13-week cash, KPI scorecard, OKRs, compliance calendar, vendor register, risk register, RACI, hiring pipeline, headcount plan and more — import it into Google Sheets).
...
| **Newly formed; no operating system yet** (assumed stage)                                   | Everything here starts from a blank page. Order matters — the [[00-course-map-and-timeline                                                                                         | master timeline]] tells you what to set up in which week. |
...
| --------------------------- | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- | --------------- |
| **0 — Orientation**         | Now         | this page, [[00-course-map-and-timeline]]                                                                                                                                                                                                                       | See the whole road, week by week                                                         |
...
| **Toolkit**                 | Always      | [[toolkit/index                                                                                                                                                                                                                                                 | 30 templates]] + [vsyst-coo-workbook.xlsx](toolkit/vsyst-coo-workbook.xlsx)              | Copy, fill, run |
| **Reference**               | Always      | [[21-reference-glossary-reading-list-and-sources]]                                                                                                                                                                                                              | Look up any term, book or source                                                         |

Start with [[00-course-map-and-timeline]] to see the road, then [[01-what-is-a-coo]].
...
- **Follow the timeline, not the table of contents.** Lessons are grouped by topic; the [[00-course-map-and-timeline|timeline]] tells you what to actually do in week 1, week 2, month 3. In a newly formed company you will read lesson 13 (compliance) long before month 6, because the first GST/TDS date does not wait.
