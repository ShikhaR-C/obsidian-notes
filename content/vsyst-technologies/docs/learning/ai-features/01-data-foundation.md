...
| 8   | **English-only app, no i18n scaffolding**          | Multilingual assistant/voice needs language prefs per user                                                               | Add `lang` to `users`; genAI can _respond_ in any language regardless, but UI strings need i18n eventually                                            |
