...
The two compound: discriminative models **detect and predict**, generative models **explain and act on** those predictions in the user's language. Example: a credit-risk model flags a customer (discriminative) → the assistant explains *why* and drafts the reminder message (generative).
...
1. **[01 — Data Foundation](01-data-foundation.md)** — what we have, what's missing, what to start capturing *now* (cheap schema additions that unlock everything later)
