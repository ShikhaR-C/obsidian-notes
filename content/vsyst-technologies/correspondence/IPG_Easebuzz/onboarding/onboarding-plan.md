...
- [ ] Step 9 — Read-through; export to `.docx`; create policy pages.
  ...
  - [ ] 9b Export to `.docx`
  - [ ] 9c Create policy pages for vsyst.in
...
## Open questions for the user — remaining placeholders

Every ⟨placeholder⟩ left in the eight documents, grouped by the answer needed. Line numbers as of 2026-08-22.

| #   | Answer needed                                    | Current placeholder text                                                                            | Where it appears                                                                                                                                                                                                                                                                    |
| --- | ------------------------------------------------ | --------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Registered address exactly as on GST certificate | ⟨A-2/11, Udaya Society, Tatibandh, Raipur, Chhattisgarh 492099 — as per GST⟩ · ⟨address as per GST⟩ | `01` L28 (particulars table), L40 (Contact Us), L53 (footer) · `05` L14 (row F status), L16 (footer line) · `06` L53 (footer) · `07` L97 (footer) · `08` L24 (footer). App screen Help → Contact Us (`ContactUs/index.js:166-175`) shows "Sector-1, Udaya Society…" — align to GST. |
| 2   | Traction figures as of Aug 2026                  | ⟨2⟩ outlets · ⟨130+⟩ users · ⟨130+⟩ transactions/day                                                | `01` L9 · `02` L29–31 (Scale table, Current column)                                                                                                                                                                                                                                 |
| 3   | First-phase outlet count (expected)              | ⟨10–15⟩                                                                                             | `02` L29 (Scale table, Expected column)                                                                                                                                                                                                                                             |
| 4   | Support hours                                    | ⟨Monday–Saturday, 10:00–18:00 IST⟩                                                                  | `01` L46 (Contact Us table)                                                                                                                                                                                                                                                         |
| 5   | Grievance officer name and email                 | ⟨Name⟩ · ⟨email⟩                                                                                    | `01` L49 · `06` L45 (§9) · `07` L93 (cl. 21) · `08` L17 (§3.1)                                                                                                                                                                                                                      |
| 6   | Grievance SLAs — acknowledge / resolve           | ⟨48 hours⟩ · ⟨30 days⟩                                                                              | `01` L49 · `06` L45 · `07` L89 (cl. 20), L93 (cl. 21) · `08` L17 (§3.1), L20 (§3.4)                                                                                                                                                                                                 |
| 7   | Courts / jurisdiction                            | ⟨Raipur, Chhattisgarh⟩                                                                              | `06` L49 (§10) · `07` L89 (cl. 20) · `08` L13 (§2)                                                                                                                                                                                                                                  |
| 8   | Policy effective dates                           | ⟨date⟩                                                                                              | `06` L3 · `07` L3 · `08` L3 (title lines, "Last updated")                                                                                                                                                                                                                           |
| 9   | Refund initiation window after dealer approval   | ⟨7⟩ working days                                                                                    | `06` L24 (§4 Timeline)                                                                                                                                                                                                                                                              |
| 10  | Bank / card-network credit window                | ⟨5–10⟩ working days                                                                                 | `06` L24 (§4 Timeline)                                                                                                                                                                                                                                                              |
| 11  | Failed-payment auto-reversal window              | ⟨7⟩ working days                                                                                    | `06` L29 (§5)                                                                                                                                                                                                                                                                       |
| 12  | Subscription refund stance                       | ⟨not refunded⟩                                                                                      | `06` L41 (§8)                                                                                                                                                                                                                                                                       |
| 13  | Liability cap                                    | ⟨the fees you paid to VSYST in the twelve months before the claim, or ₹10,000 if none⟩              | `07` L73 (cl. 16)                                                                                                                                                                                                                                                                   |
| 14  | Web channel — does the OMS have a web app?       | ⟨and web⟩                                                                                           | `03` L39 (Channels)                                                                                                                                                                                                                                                                 |
| 15  | Auto-clear window for abandoned gateway payments | ⟨24 hours⟩                                                                                          | `04` L38 (Part B, "Failed or abandoned")                                                                                                                                                                                                                                            |
| 16  | Final page URLs on vsyst.in                      | ⟨https://vsyst.in/refund-policy⟩ · ⟨…/terms⟩ · ⟨…/contact⟩ · ⟨…/about⟩ · ⟨…/governing-law⟩          | `05` L9–13 (column "Published on the website")                                                                                                                                                                                                                                      |
| 17  | In-app placement of policies                     | ⟨to add⟩                                                                                            | `05` L9 (A: Settings → Policies), L10 (B: Settings → Policies; accepted at sign-up), L12 (D: Help → About)                                                                                                                                                                          |
| 18  | Publication status (flip at Step 9c)             | ⟨Drafted — pending publication⟩ · ⟨Pending — GST address verbatim⟩                                  | `05` L9–13 (column "Status"), L14 (row F)                                                                                                                                                                                                                                           |
