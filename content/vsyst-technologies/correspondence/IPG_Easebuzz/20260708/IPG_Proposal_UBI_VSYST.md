...
## 3. Supporting Unorganised/Untouched Leg of Fuel Retail Market
...
Expansion has a ready starting point: the Bank already extends channel-finance facilities to HPCL petrol pump dealers, giving Phase 2 a dealer cohort with existing UBI relationships to onboard first.

Beyond the immediate business case, we see a wider significance in this program. Payment automation of this grade has largely been the preserve of large organisations; this partnership extends it to an underserved market of retail outlet dealers and transport companies, bridging two industries that transact with each other every day yet still operate over informal channels where mistrust, tension, and fraud risk persist. DZZLO on the Bank's rails replaces that opacity with verified counterparties, a transparent common ledger, and payments both sides can trust — strengthening honest business ties across the ecosystem. The gateway will further allow customers to maintain advance top-up balances with their dealers, deepening these business relationships and adding a recurring stream of collections through the Bank.

This venture is deeply encouraging for us, and promises real relief and peace of mind to dealers and transport operators. It builds on the efforts Union Bank of India has invested in this sector over the years, and we believe it can prove a feather in the Bank's cap — a UBI-led transformation that opens new possibilities for the vast network of fuel retailers and transport businesses across the nation. We request the Bank's approval to commence the Phase-1 pilot, and would be glad to demonstrate the live platform and our current transaction flows at the Bank's convenience.
