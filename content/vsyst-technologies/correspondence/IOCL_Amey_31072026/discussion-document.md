...
<!--
DRAFT — polish pass 2026-08-01
- Topic list still under review; "Why Amey" pending author points.
- All points reframed for brevity on author's instruction (2026-08-01): short, plain, interesting.
  Nothing is verbatim any more — quotation marks removed. Provenance for every point lives in
  references.md ([vault] / [vault, edited] / [author]); author points all preserved.
- Numbers and stats kept exactly as sourced/dictated — nothing invented.
-->
...
1. **Shared values.** IndianOil states its values in four words — Care, Innovation, Passion, Trust — and stands a fifth beside them: Nation-First. We recognise our own vision in every line.
2. **Unmatched scale.** India runs 1,00,266+ pumps, the world's third-largest network — and IOCL leads it with a 41.5% share.
3. **A ready foundation.** XTRAPOWER alone is accepted at 25,000+ outlets and moves over ₹60,000 Cr a year — a direct integration target.
4. **A gap only software can close.** Fleet-card penetration is under 13% of IOCL's own loyal base — cards solve payment, not the ledger.
5. **Vision plus network.** IOCL has both — and a history of backing work that helps the country.

## 3. Problems on the Ground

### 3.1 Problem of dealers with transporters

1. **Credit that walks away.** A customer fuels up on credit and never returns; a driver denies the fill, sends someone else, or simply drives off.
2. **The 15+15 squeeze.** Customers stretch 15 days of credit into 30 — the dealer's investment doubles, and recovery ends in pleading.
3. **Funds stuck in paperwork.** Missing bills, absent accountants, misplaced slips, payments not made bill-wise — reconciliation holds the money hostage.
4. **The exposure is real.** A typical 200 KL/month highway pump carries ₹30–60 lakh in month-end receivables and quietly absorbs 1–3% a year as bad debt.
5. **Everyone else's software.** Each big customer imposes their own system on the dealer — who needs one platform, not ten.
...
1. **Every bill re-checked.** Billing errors, unknown or unreachable dealers, TCS/TDS confusion, and endless reconciliation just to know what is owed to whom.
2. **The slip game.** The attendant fills 40 litres and writes 45; driver and attendant split the difference.
3. **Rate hide-and-seek.** Rates must be requested dealer-wise, date-wise, product-wise — and then re-checked.
4. **Business by WhatsApp group.** A rate group, an order group, a payment group — and multi-dealer payments with taxes reconciled again and again.
5. **Too small to serve.** Dealers do not entertain small customers.
...
2. **One ledger, no suspense accounts.** Unpaid bills are visible by default; payment is made date-wise, dealer-wise, bill-wise — settled in one shot.
3. **A corporate back office at a transporter's price.** Multiple firms and sister concerns run from one system; any year's records filtered in seconds; no software to build or maintain.
4. **The OTP is his paperwork.** Delivery is confirmed from the phone in the driver's pocket — no slips to lose, no blame to carry.
5. **Fuel that cannot leak.** Real-time consumption per vehicle and per driver, litres-per-km variance alerts, OTP authentication — the tank cannot fill without a verified driver.
6. **Ease, at last.** Overburdened transporters feel the diesel side of their business go quiet.
...
5. **First-mover at minimum cost.** Early start, fast nationwide rollout, easy setup, accurate data — for the smallest of funds.
6. **Sees what ITPS cannot.** Customer-wise credit litres, tracked daily.
7. **Proof at our own pump.** Our RO saw ~300% sale growth (MS 30→80, HSD 125→400) — driven by DZZLO's transparency, accuracy, efficiency and trust. One third was dealer hard work, one third IOCL's facilities, one third full use of both plus DZZLO. Two years as a pilot, one year ad-hoc, now integrating AI. If IOCL's sale grows even 3–5%, we call it an achievement.
